...
│   │   └── api文档/                # 后端API接口文档
│   │       ├── API接口文档.md      # API接口总览
│   │       ├── DNSPod查询可用三级域名接口.md # DNSPod接口文档
│   │       ├── JWT认证过滤器.md    # JWT认证文档
│   │       ├── 域名后缀接口.md     # 域名后缀接口文档
│   │       ├── 用户三级域名管理接口文档.md # 域名管理接口文档
│   │       ├── 用户注册接口.md     # 用户注册接口文档
│   │       ├── 用户登出接口.md     # 用户登出接口文档
│   │       ├── 用户登录接口.md     # 用户登录接口文档
│   │       └── 获取3级域名解析列表接口.md # 域名解析列表接口文档
│   ├── rule.md                     # 基础规则文档
│   ├── 代码编写约定规则/
│   │   ├── formatting-rules.md     # 代码格式规则
│   │   ├── testing-rules.md        # 测试规则
│   │   ├── typescript-rules.md     # TypeScript规则
│   │   ├── vue-component-rules.md  # Vue组件规则
│   │   ├── vuetify-rules.md        # Vuetify使用规则
│   │   └── 代码编写约定规则.md      # 代码编写约定规则总览
│   ├── 测试数据.md                 # 测试数据文档
│   ├── 项目介绍.md                 # 项目介绍文档
...
│   │   ├── dialog-test.vue         # 对话框测试页面
│   │   ├── dns-manage.vue          # DNS管理页面
│   │   ├── domain-manage.vue       # 域名管理页面
│   │   ├── domain-register.vue     # 域名注册页面组件
│   │   ├── domain-test.vue         # 域名测试页面
...
│       ├── README.md               # 工具函数说明
│       └── http.ts                 # HTTP 请求工具
├── test-domain-api.js              # 域名API测试脚本
├── test-login-api.cjs              # 登录API测试脚本(CommonJS)
├── test-login-api.js               # 登录API测试脚本
├── test-login.html                 # 登录测试HTML
